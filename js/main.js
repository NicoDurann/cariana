...
// Si el usuario toca la tecla escape se cierra el modalBanner
...
// si el usuario toca la tecla espace se cierra el detalle del producto;
document.addEventListener("keydown", (e) => {
  if (e.key === "Escape") {
...
// si el usuario toca la tecla espace se cierra el carrito;
document.addEventListener("keydown", (e) => {
  if (e.key === "Escape") {
